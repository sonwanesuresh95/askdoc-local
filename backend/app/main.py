...
from app.api import routes_upload, routes_query, routes_document, routes_debug_vectorstore, routes_reset
...
app.include_router(routes_reset.router, prefix="/api", tags=["Reset"])
